...
if __name__ == '__main__':
    ...
    # 模型加载与命名
    VERSION = 'bottleneck_experiment_latent_new_512_beta1.0' # 采用非预训练模型
    ...
    parser.add_argument('--ckpt_name', default='lightning_logs/bottleneck_experiment_latent_new_512_beta1.0/checkpoints/saved_models/last.ckpt', type = str )
