...
def main(args):
    ...
    if args.RESUME:
        ...
        trainer.fit(bottlenecknets, datamodule=data_module, ckpt_path='lightning_logs/bottleneck_experiment_latent_new_512_beta0.00001/checkpoints/saved_models/last.ckpt')
