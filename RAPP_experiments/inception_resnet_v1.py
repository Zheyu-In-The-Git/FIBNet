...
if __name__ == '__main__':
    resnet_inception = InceptionResnetV1(pretrained='vggface2')
    print(resnet_inception)
    facenet_vggface2_path = r'C:\Users\Administrator\PycharmProjects\Bottleneck_Nets\RAPP\lightning_logs\facenet-vggface2.pt'
    resnet_inception.load_state_dict(torch.load(facenet_vggface2_path))
    print(resnet_inception)
    #del resnet_inception.last_bn
    #del resnet_inception.logits
    resnet_inception.last_bn = nn.Sequential()
    print(resnet_inception)

    x = torch.rand(size=(8, 3, 224, 224))
    output = resnet_inception(x)
    print(output.size())
