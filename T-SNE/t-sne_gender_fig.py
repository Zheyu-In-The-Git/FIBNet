...
Arcface_lfw_path = os.path.abspath(r'files_npz_pdf/t-sne_Male_Arcface_lfw.npz')
...
Bottleneck_01_lfw_path = os.path.abspath(r'files_npz_pdf/t-sne_Male_Bottleneck_0.1_lfw.npz')
...
with plt.style.context(['science','ieee', 'high-contrast','grid']):
    ...
    obj_male = bottleneck_adience_ax.scatter(Bottleneck_01_adience_boolean_1[:, 0], Bottleneck_01_adience_boolean_1[:, 1], label='Male', s=1, c='b', marker='.')
    obj_female = bottleneck_adience_ax.scatter(Bottleneck_01_adience_boolean_0[:, 0], Bottleneck_01_adience_boolean_0[:, 1], label='Female', s=1, c='r', marker='.')
