...
# arcface相关降维数据
Arcface_celeba_path = os.path.abspath(r'files_npz_pdf/t-sne_White_Arcface_celeba.npz')
Arcface_lfw_path = os.path.abspath(r'files_npz_pdf/t-sne_White_Arcface_lfw.npz')
Arcface_adience_path = os.path.abspath(r'files_npz_pdf/t-sne_White_Arcface_adience.npz')

# bottleneck相关降维数据
Bottleneck_01_celceba_path = os.path.abspath(r'files_npz_pdf/t-sne_White_Bottleneck_0.1_celeba.npz')
Bottleneck_01_lfw_path = os.path.abspath(r'files_npz_pdf/t-sne_White_Bottleneck_0.1_lfw.npz')
Bottleneck_01_adience_path = os.path.abspath(r'files_npz_pdf/t-sne_White_Bottleneck_0.1_adience.npz')
...
with plt.style.context(['science','ieee', 'high-contrast','grid']):
    ...
    # CelebA数据
    arcface_celeba_ax.scatter(Arcface_celeba_boolean_1[:, 0], Arcface_celeba_boolean_1[:, 1], label='Male', s=1 , c = 'b', marker='.')
    arcface_celeba_ax.scatter(Arcface_celeba_boolean_0[:, 0], Arcface_celeba_boolean_0[:, 1], label='Female', s=1, c = 'r', marker='.')
    ...
    # LFW 数据
    arcface_lfw_ax.scatter(Arcface_lfw_boolean_1[:, 0], Arcface_lfw_boolean_1[:, 1], label='Male', s=1, c='b', marker='.')
    arcface_lfw_ax.scatter(Arcface_lfw_boolean_0[:, 0], Arcface_lfw_boolean_0[:, 1], label='Female', s=1, c='r', marker='.')
    #arcface_lfw_ax.autoscale(tight=True)
    arcface_lfw_ax.set_title('LFW')

    # Adience 数据
    arcface_adience_ax.scatter(Arcface_adience_boolean_1[:, 0], Arcface_adience_boolean_1[:, 1], label='Male', s=1, marker='.', c='b')
    arcface_adience_ax.scatter(Arcface_adience_boolean_0[:, 0], Arcface_adience_boolean_0[:, 1], label='Female', s=1, marker='.', c='r')
    #arcface_adience_ax.autoscale(tight=True)
    arcface_adience_ax.set_title('Adience')


    # Bottlenck
    bottleneck_celeba_ax.scatter(Bottleneck_01_celeba_boolean_1[:, 0], Bottleneck_01_celeba_boolean_1[:, 1], label='Male', s=1, c='b', marker='.')
    bottleneck_celeba_ax.scatter(Bottleneck_01_celeba_boolean_0[:, 0], Bottleneck_01_celeba_boolean_0[:, 1], label='Female', s=1, c='r', marker='.')
    bottleneck_celeba_ax.set(ylabel=r'$\beta$ = 0.1')


    bottleneck_lfw_ax.scatter(Bottleneck_01_lfw_boolean_1[:, 0], Bottleneck_01_lfw_boolean_1[:, 1], label='Male', s=1, c='b', marker='.')
    bottleneck_lfw_ax.scatter(Bottleneck_01_lfw_boolean_0[:, 0], Bottleneck_01_lfw_boolean_0[:, 1], label='Female', s=1, c='r', marker='.')


    obj_white = bottleneck_adience_ax.scatter(Bottleneck_01_adience_boolean_1[:, 0], Bottleneck_01_adience_boolean_1[:, 1], label='Male', s=1, c='b', marker='.')
    obj_colored_people = bottleneck_adience_ax.scatter(Bottleneck_01_adience_boolean_0[:, 0], Bottleneck_01_adience_boolean_0[:, 1], label='Female', s=1, c='r', marker='.')

    fig.legend((obj_white, obj_colored_people ),['White', 'Colored people'],
               loc="lower center", ncol=6, bbox_to_anchor=(0, 0.0, 1, 0))  # bbox_to_anchor=(0, 1.02, 1, 0.1)


    fig.savefig('t-sne-race.pdf', dpi=1000)
