...
Arcface_lfw_path = os.path.abspath(r'files_npz_pdf/t-sne_White_Arcface_lfw_casia.npz')
...
Bottleneck_01_lfw_path = os.path.abspath(r'files_npz_pdf/t-sne_White_Bottleneck_0.1_lfw_casia.npz')
...
with plt.style.context(['science','ieee', 'high-contrast','grid']):
    ...
    fig.legend((obj_white, obj_colored_people ),['Caucasian', 'non-Caucasian'],
