...
from data import CelebaTSNEExperiment, CelebaTSNERaceExperiment, LFWTSNEExperiment, AdienceTSNEGenderExperiment, AdienceTSNERaceExperiment
...
arcface = arcface_resnet50_net.load_from_checkpoint(
    r'C:\Users\Administrator\PycharmProjects\Bottleneck_Nets\lightning_logs\arcface_recognizer_resnet50_latent512\checkpoints\saved_model\face_recognition_resnet50\last.ckpt')
...
bottlenecknets = BottleneckNets(model_name='bottleneck', encoder=encoder, decoder=decoder, beta=0.1, batch_size=64,
                                identity_nums=10177)
...
model = bottlenecknets.load_from_checkpoint(
    r'C:\Users\Administrator\PycharmProjects\Bottleneck_Nets\lightning_logs\bottleneck_experiment_latent_new_512_beta0.01\checkpoints\saved_models\last.ckpt',
...
np.savez('t-sne.npz',X_tsne_data=X_tsne_data) # 可能就是前500个是1，后500个是0
...
def TSNEExperiment(model_name, sensitive_attr, dataloader, data_name):
    ...
    if model_name == 'Arcface':
        ...
        tsne = TSNE(n_components=2, perplexity=30.0, early_exaggeration=100.0, learning_rate=20.0, n_iter=4300,
                    n_iter_without_progress=300, min_grad_norm=1e-07, metric='cosine', init='pca', verbose=1,
                    random_state=83, method='barnes_hut',
    ...
    #####################################################
        ...
        # model = bottlenecknets.load_from_checkpoint(r'C:\Users\40398\PycharmProjects\Bottleneck_Nets\lightning_logs\bottleneck_experiment_latent_new_512_beta0.01\checkpoints\saved_models\last.ckpt', encoder=encoder,decoder=decoder)
