...
def TSNEExperiment(model_name, sensitive_attr, dataloader, data_name):
    ...
    if model_name == 'Arcface':
        ...
        if sensitive_attr == 'Male':
            ...
            sns.scatterplot(data=df_tsne, hue='race', x='Dim1', y='Dim2')  # markers=markers
            # sns.scatterplot(data=df_tsne, hue='gender') # 不打 x轴 和 y轴
...
if __name__ == '__main__':
    ...
    TSNEExperiment(model_name='Arcface', sensitive_attr='White', dataloader=lfw_race_dataloader, data_name='celeba')
    TSNEExperiment(model_name='Arcface', sensitive_attr='White', dataloader=adience_race_dataloader, data_name='celeba')
    ...
    TSNEExperiment(model_name='Bottleneck_0.1', sensitive_attr='White', dataloader=lfw_race_dataloader, data_name='celeba')
    TSNEExperiment(model_name='Bottleneck_0.1', sensitive_attr='White', dataloader=adience_race_dataloader, data_name='celeba')
