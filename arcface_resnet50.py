...
class ArcfaceResnet50(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler = optim.lr_scheduler.ReduceLROnPlateau(optim_train, mode="min", factor=0.5, patience=5, min_lr=1e-6)
    ...
    def test_epoch_end(self, outputs):
        ...
        torch.save(arcface_confusion_cos,
                   r"/lightning_logs/arcface_recognizer_resnet50_latent512/arcface_confusion_cos.pt")
