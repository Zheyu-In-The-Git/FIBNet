...
with open(r'E:\Bottleneck_Nets\lightning_logs\resnet50_scratch_weight.pkl', 'rb') as f:
...
class ArcfaceResnet50(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler = optim.lr_scheduler.ReduceLROnPlateau(optim_train, mode="min", factor=0.1, patience=5, min_lr=1e-6, threshold=1e-3)
